...
Embedded.prototype.addControls = function() {
  ...
  // this.editor.editor_el.appendChild(svg);
  el.appendChild(svg);

  // var transformObject = svg.createSVGTransform();
  // svg.transform.baseVal.appendItem(transformObject);
  // svg.transform.baseVal.getItem(0).setRotate(Math.PI/4, 12, 12);
